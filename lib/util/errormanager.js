...
var check = {
    ...
    "Dimensions" : function() {
        ...
        if (remain.match(/"[\w\W]*\.json"/) && dimensions.length > 0) {
            try {
    ...
    "DataProvider" : function() {
        var args = arguments, dataProvider = args[0], logger = dataProvider.logger,
            errorMessage = args[1], proc = dataProvider.mock || process, match;
    ...
    "SeleniumDriver" : function(seleniumDriver, errorMessage, currentUrl) {
