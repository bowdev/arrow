...
WebServiceController.prototype.execute = function(callback) {
    ...
    self.logger.debug("WebServiceController.prototype.execute");
    ...
    var req = http_protocol.request(http_opts, function(res) {
        callback("finished http_protocol.request");
        ...
        res.on('end', function () {
            self.logger.debug("end ----------------- WebServiceController.prototype.execute");
