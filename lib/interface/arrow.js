...
Arrow.prototype.runController = function (controllerName, testConfig, testParams, driver, callback) {
    var self = this,
        testWaitingTimeout = testParams.testWaitingTimeout || testConfig.testWaitingTimeout || 60000,
        ControllerClass,
        controller,
        ctrName,
    ...
    function controllerExecuteCallback (error, data) {
        if (self.controllerCallback) {
            delete self.controllerCallback;
